...
const AnimatedButton = ({
    ...
    return (
        <Component
            ...
            className={`px-6 py-2 rounded-md relative overflow-hidden bg-neutral-50 dark:bg-black flex justify-center items-center border border-neutral-300 dark:border-neutral-800 text-neutral-900 dark:text-neutral-100 [--shine:rgba(0,0,0,.66)] dark:[--shine:rgba(255,255,255,.66)] ${className}`}
        >
            <motion.span
